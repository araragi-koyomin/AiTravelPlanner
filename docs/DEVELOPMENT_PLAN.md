...
- [x] 实现导出为 PDF（使用 jsPDF + html2canvas）
- [x] 实现导出为图片（PNG/JPEG，使用 html2canvas）
- [x] 实现导出选项（格式、质量、方向、内容选择）
- [x] 实现导出进度提示
- [x] 修复 PDF 中文乱码问题
- [x] 修复 PDF 分页问题
- [x] 修复横向导出比例问题
- [x] 修复导出格式选择问题
- [x] 单元测试（126 个测试用例，覆盖率 90%+）
- [x] 验收报告（Task3.2-行程导出功能验收报告.md）

**交付物：**

- ✅ 行程导出功能
- ✅ PDF 和图片导出（支持中文）
- ✅ 导出选项组件（ExportModal、ExportButton）
- ✅ 导出服务层（export.ts）
- ✅ 导出工具函数（exportUtils.ts）
- ✅ 导出类型定义（export.ts）
- ✅ 完整的测试覆盖
