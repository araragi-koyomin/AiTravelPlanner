...
│   ├── Task2.8-语音识别功能测试报告.md  # 语音识别功能测试报告
│   └── Task2.8-语音识别功能验收报告.md  # 语音识别功能验收报告
│   ├── Task2.9-费用预算功能测试报告.md  # 费用预算功能测试报告
│   └── Task2.9-费用预算功能验收报告.md  # 费用预算功能验收报告
│   ├── Task2.10-费用记录功能测试报告.md # 费用记录功能测试报告
│   └── Task2.10-费用记录功能验收报告.md # 费用记录功能验收报告
│   ├── Task3.2-行程导出功能测试报告.md # 行程导出功能测试报告
│   └── Task3.2-行程导出功能验收报告.md # 行程导出功能验收报告
├── .trae/                   # 项目规则和模板
│   ├── rules/               # 项目规则
│   │   └── project_rules.md
│   └── templates/           # Git 模板
